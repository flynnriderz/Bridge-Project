...
class SectionEntry {
  ...
  static SectionEntry fromDoc(DocumentSnapshot doc) {
  ...
  @override
  String toString() => 'SectionEntry board: $board, board_round: $board_round, key: $key, movement: $movement, key: $key, movement: $movement, pin: $pin, table: $table, section_name: $section_name, type: $type, time: $time';

  @override
  bool operator ==(Object o) {
    if (identical(this, o)) return true;

    return o is SectionEntry &&
        o.movement == movement &&
        o.board == board &&
