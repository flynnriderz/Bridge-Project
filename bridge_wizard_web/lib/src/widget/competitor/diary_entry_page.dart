...
import 'package:bridge_wizard_web/src/widget/competitor/diary_entry_button.dart';
...
class _DiaryEntryPageState extends State<DiaryEntryPage> {
  ...
  @override
  void initState() {
    _emoji = widget.diaryEntry?.team_NO.toString() ?? '';
    numberTextController =
        TextEditingController(text: widget.diaryEntry?.team_NO.toString() ?? '');
    teamTextController =
